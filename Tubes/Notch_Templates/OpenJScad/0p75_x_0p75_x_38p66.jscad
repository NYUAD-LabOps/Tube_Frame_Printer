...
function getParameterDefinitions() {
  return [
    { name: 'od1', type: 'float', initial: 19.05, caption: "Outer diameter of notched tube:" },
    { name: 't2', type: 'float', initial: 2.413, caption: "Wall thickness of notched tube:" },
 { name: 'od2', type: 'float', initial: 19.05, caption: "Outer diameter of mating tube (must be equal to or larger than notched tube):" },
 { name: 'angle', type: 'float', initial: 38.66, caption: "Angle between tubes:" },
