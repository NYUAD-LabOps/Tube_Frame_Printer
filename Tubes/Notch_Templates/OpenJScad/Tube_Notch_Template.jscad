...
function getParameterDefinitions() {
  return [
    { name: 'od1', type: 'float', initial: 0.75, caption: "Outer diameter of notched tube:" },
    { name: 't2', type: 'float', initial: 0.0950, caption: "Wall thickness of notched tube:" },
 { name: 'od2', type: 'float', initial: 1.25, caption: "Outer diameter of mating tube (must be equal to or larger than notched tube):" },
 ...
 { name: 'h', type: 'float', initial: 2.5, caption: "Height of template from base to intersection point of tube center lines:" },
